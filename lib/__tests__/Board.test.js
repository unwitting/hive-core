...
describe('applyMove', () => {
  ...
  describe.skip('queen', () => {
    ...
    test('cannot move more than 1 space', () => {
      ...
      board.applyMove('Q+2,0', 4)
      // Apply attempted next moves to clones of the board
      expect(() => board.applyMove('Q>0,1', 5)).toThrowError('QUEEN_MUST_MOVE_ONE')
      expect(() => board.applyMove('Q>1,1', 5)).toThrowError('QUEEN_MUST_MOVE_ONE')
      expect(() => board.applyMove('Q>2,1', 5)).toThrowError('QUEEN_MUST_MOVE_ONE')
      expect(() => board.applyMove('Q>1,-1', 5)).toThrowError('QUEEN_MUST_MOVE_ONE')
      expect(() => board.applyMove('Q>2,-1', 5)).toThrowError('QUEEN_MUST_MOVE_ONE')
      expect(() => board.applyMove('Q>3,-1', 5)).toThrowError('QUEEN_MUST_MOVE_ONE')
      expect(() => board.applyMove('Q>3,0', 5)).toThrowError('QUEEN_MUST_MOVE_ONE')
    })
    ...
    test('cannot violate freedom of movement', () => {
      ...
      expect(() => board.applyMove('Q>0,1', 7)).toThrowError('NOT_FREE_TO_MOVE_TO_TARGET')
    })
    ...
    test('cannot violate one hive rule', () => {
      ...
      expect(() => board.applyMove('Q>-1,0', 6)).toThrowError('HIVE_CANNOT_SPLIT')
    })
  })
  ...
  describe.skip('ant', () => {
    ...
    test('cannot violate freedom of movement', () => {
      ...
      // Attempt to move into impossible gap
      expect(() => board.applyMove('A[-1,1]>0,1', 7)).toThrowError('NOT_FREE_TO_MOVE_TO_TARGET')
    })
    ...
    test('cannot violate one hive rule', () => {
      ...
      // Attempt to split hive
      expect(() => board.applyMove('A[0,0]>-1,0', 6)).toThrowError('HIVE_CANNOT_SPLIT')
    })
  })

  describe.skip('spider', () => {
    ...
    test('cannot move more or less than 3 spaces', () => {
      ...
      board.applyMove('S+3,0', 6)
      // Apply attempted next moves to clones of the board
      expect(() => board.applyMove('S>-1,1', 7)).toThrowError('SPIDER_MUST_MOVE_THREE')
      expect(() => board.applyMove('S>1,1', 7)).toThrowError('SPIDER_MUST_MOVE_THREE')
      expect(() => board.applyMove('S>0,-1', 7)).toThrowError('SPIDER_MUST_MOVE_THREE')
      expect(() => board.applyMove('S>2,-1', 7)).toThrowError('SPIDER_MUST_MOVE_THREE')
      expect(() => board.applyMove('S>-2,1', 7)).toThrowError('SPIDER_MUST_MOVE_THREE')
      expect(() => board.applyMove('S>4,0', 7)).toThrowError('SPIDER_MUST_MOVE_THREE')
    })
    ...
    test('cannot violate freedom of movement', () => {
      ...
      // Attempt to move into impossible gap
      expect(() => board.applyMove('S>0,1', 7)).toThrowError('NOT_FREE_TO_MOVE_TO_TARGET')
    })
    ...
    test('cannot violate one hive rule', () => {
      ...
      // Attempt to split hive
      expect(() => board.applyMove('S[0,0]>-2,2', 6)).toThrowError('HIVE_CANNOT_SPLIT')
    })
  })
})
